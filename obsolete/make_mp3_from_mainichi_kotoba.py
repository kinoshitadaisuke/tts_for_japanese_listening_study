...
#
# Time-stamp: <2025/10/03 22:21:50 (UT+08:00) daisuke>
#
...
descr  = f'Downloading Mainichi News Kotoba and generating MP3 file'
...
if not ('https://mainichi.jp/maisho/' in url_mainichi):
    # printing a message
    print ("ERROR:")
    print ("ERROR: specified URL is not for Mainichi maisho news kotoba article.")
    print ("ERROR:")
    # exit
    sys.exit (0)
